...
class _list_food extends State<list_food> {
  ...
  Future getOrderList()async{
    _db.collection('orders').orderBy('date',descending: false).snapshots().listen((docs){
      setState(() {
                  ...
                  return Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        Expanded(
                          child: Container(
                            child: Text("โต๊ะ #${orderList[index].data['table']}",style: nameFontStyle,),
                          ),
                        ),
                        Expanded(
                          child: Container(
                            ...
                            child: GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return order_detail(orderList[index].documentID);
                                }));
                              },
                                                          child: Container(
                                alignment: Alignment.center,
